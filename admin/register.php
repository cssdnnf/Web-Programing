...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check_result) > 0) {
        header('Location: ./register.php?error=username_duplikat');
        exit;
    } else {
        $query = "INSERT INTO users (username, password, level, name) 
                  VALUES ('$username', md5('$password'), 'user', '$name')";
                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="" method="post">
                                ...
                                <div class="text-center mt-35">
									<input type="submit" value="Daftar Akun" class="btn btn-primary btn-user btn-block"></input>
								</div>
                            </form>
                            <hr>
                            <div class="text-center">
