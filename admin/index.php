...
<head>
    ...
    <title>Web Programming - Dashboard</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="text-transform: uppercase;"><?php echo $users['name']." | (Level: ". $users['level'].")"; ?></span>
